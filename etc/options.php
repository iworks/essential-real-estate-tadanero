<?php
/**
 * Tadanero: Essential Real Estate Options Configuration
 *
 * This file contains the configuration options for the Tadanero: Essential Real Estate.
 ...
 * @since 1.0.0
 */
function iworks_essential_real_estate_tadanero_options() {
	/**
	...
	$options['index'] = array(
		 ...
		 */
		'page_title' => __( 'Tadanero: Essential Real Estate', 'essential-real-estate-tadanero' ),
 ...
 */
		 ...
		 * Array of metaboxes
		 */
		'metaboxes'  => apply_filters( 'essential-real-estate-tadanero/etc/config/metaboxes', array() ),

		/**
		 * Array of subpages
		 */
		'pages'      => apply_filters( 'essential-real-estate-tadanero/etc/config/pages', array() ),
	);
