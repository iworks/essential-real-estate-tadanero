<?php
/**
 * iWorks Tadanero: Essential Real Estate Base Class
 *
 * This is the base class for the Tadanero: Essential Real Estate, providing
 ...
 */
if ( class_exists( 'iworks_essential_real_estate_tadanero_base' ) ) {
	return;
}
 ...
 * iWorks Tadanero: Essential Real Estate Base Class
 *
 * This class provides the foundation for the Tadanero: Essential Real Estate,
 * offering essential properties and methods used throughout the plugin.
 *
 * @since 1.0.0
 */
class iworks_essential_real_estate_tadanero_base {
	...
	public function __construct() {
		 ...
		 * plugin ID
		 */
		$this->plugin_file_path = $this->base . '/essential-real-estate-tadanero.php';
		$this->plugin_file      = plugin_basename( $this->plugin_file_path );
		/**
		 * plugin includes directory
		 */
		$this->includes_directory = __DIR__ . '/essential-real-estate-tadanero';
		/**
		 * WordPress Hooks
		 */
	}
	...
	protected function check_option_object() {
		...
		$this->options = iworks_essential_real_estate_tadanero_get_options();
	}
