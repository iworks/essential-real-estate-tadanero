...
if ( class_exists( 'iworks_essential_real_estate_tadanero_github' ) ) {
	return;
}

class iworks_essential_real_estate_tadanero_github {
	 ...
	 * @since 1.0.0
	 */
	private string $repository = 'iworks/essential-real-estate-tadanero';
	/**
	 * Plugin base name
	 *
	 * @since 1.0.0
	 */
	private string $basename = 'essential-real-estate-tadanero';
	/**
	 * Plugin file name
	 *
	 * @since 1.0.0
	 */
	private string $plugin_file = 'essential-real-estate-tadanero.php';
	/**
	 * Github Response
	 *
	 * @since 1.0.0
	...
	public function action_init_load_plugin_textdomain() {
		...
		load_plugin_textdomain( 'essential-real-estate-tadanero', false, $dir );
	}
	...
	public function plugin_popup( $result, $action, $args ) {
		...
		$details = get_plugin_data( dirname( $this->base ) . '/essential-real-estate-tadanero.php' );
