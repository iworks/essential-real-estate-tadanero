...
class iworks_essential_real_estate_tadanero_posttype_project extends iworks_essential_real_estate_tadanero_posttype_base {
	...
	public function action_init_settings() {
		...
		$this->meta_boxes[ $this->posttypes_names[ $this->posttype_name ] ] = array(
			'project-data'  => array(
				'title'  => __( 'Project Data', 'essential-real-estate-tadanero' ),
				'fields' => array(
					array(
						'name'  => 'icon',
						'type'  => 'image',
			...
			'project-media' => array(
				'title'  => __( 'Project Media', 'essential-real-estate-tadanero' ),
				'fields' => array(
					array(
						'name'  => 'icon',
						'type'  => 'image',
	...
	public function setup() {
		$this->partners_types = array(
			'lider'         => __( 'Liders', 'essential-real-estate-tadanero' ),
			'scientific'    => __( 'Scientific Partners', 'essential-real-estate-tadanero' ),
			'business'      => __( 'Business Partners', 'essential-real-estate-tadanero' ),
			'partner'       => __( 'Partners', 'essential-real-estate-tadanero' ),
			'subcontractor' => __( 'Subcontractors', 'essential-real-estate-tadanero' ),
		);
	}
	...
	public function get_random( $content, $posts_per_page ) {
		...
		if ( 'pl_PL' === get_locale() ) {
			...
			$content .= sprintf( '<span class="section-title">%s</span>', esc_html__( 'Projects of OPI PIB', 'essential-real-estate-tadanero' ) );
		}
	...
	public function get_list( $content ) {
		...
		if ( $url ) {
			$content .= sprintf(
				...
				$url,
				esc_html__( 'Browse all projects', 'essential-real-estate-tadanero' )
			);
		}
		return $content;
	}
		...
		foreach ( $this->fields as $key => $one ) {
			...
			if ( isset( $one['type'] ) && 'url' === $one['type'] ) {
				$value = sprintf(
					...
					esc_url( $value ),
					esc_attr__( 'Opens in a new window', 'essential-real-estate-tadanero' )
				);
	...
	public function action_init_register_post_type() {
		$labels = array(
			'name'                  => _x( 'Projects', 'Post Type General Name', 'essential-real-estate-tadanero' ),
			'singular_name'         => _x( 'Project', 'Post Type Singular Name', 'essential-real-estate-tadanero' ),
			'menu_name'             => __( 'Projects', 'essential-real-estate-tadanero' ),
			'name_admin_bar'        => __( 'Projects', 'essential-real-estate-tadanero' ),
			'archives'              => __( 'Projects', 'essential-real-estate-tadanero' ),
			'all_items'             => __( 'Projects', 'essential-real-estate-tadanero' ),
			'add_new_item'          => __( 'Add New project', 'essential-real-estate-tadanero' ),
			'add_new'               => __( 'Add New', 'essential-real-estate-tadanero' ),
			'new_item'              => __( 'New project', 'essential-real-estate-tadanero' ),
			'edit_item'             => __( 'Edit project', 'essential-real-estate-tadanero' ),
			'update_item'           => __( 'Update project', 'essential-real-estate-tadanero' ),
			'view_item'             => __( 'View project', 'essential-real-estate-tadanero' ),
			'view_items'            => __( 'View project', 'essential-real-estate-tadanero' ),
			'search_items'          => __( 'Search project', 'essential-real-estate-tadanero' ),
			...
			'items_list'            => __( 'Project list', 'essential-real-estate-tadanero' ),
			'items_list_navigation' => __( 'Project list navigation', 'essential-real-estate-tadanero' ),
			'filter_items_list'     => __( 'Filter items list', 'essential-real-estate-tadanero' ),
		);
		$args   = array(
			'can_export'          => true,
			'capability_type'     => 'page',
			'description'         => __( 'Project', 'essential-real-estate-tadanero' ),
			'exclude_from_search' => true,
			'has_archive'         => true,
			'hierarchical'        => false,
			'label'               => __( 'Projects', 'essential-real-estate-tadanero' ),
			'labels'              => $labels,
			'public'              => true,
			...
			'rewrite'             => array(
				'slug' => _x( 'Project', 'slug for single project', 'essential-real-estate-tadanero' ),
			),
		);
	...
	private function html_partners( $post, $type ) {
		...
		printf(
			...
			esc_html__( 'Add a partner', 'essential-real-estate-tadanero' )
		);
		echo '</p>';
		printf(
	...
	private function set_fields() {
		$this->fields = array(
			'_project_date_start'     => array(
				'label' => __( 'Project start date', 'essential-real-estate-tadanero' ),
				'type'  => 'date',
			),
			'_project_date_end'       => array(
				'label' => __( 'Project end date', 'essential-real-estate-tadanero' ),
				'type'  => 'date',
			),
			'_realization_date_start' => array(
				'label' => __( 'Realization start date', 'essential-real-estate-tadanero' ),
				'type'  => 'date',
			),
			'_realization_date_end'   => array(
				'label' => __( 'Realization end date', 'essential-real-estate-tadanero' ),
				'type'  => 'date',
			),
			'_project_cost'           => array(
				'label'    => __( 'Project cost', 'essential-real-estate-tadanero' ),
				'type'     => 'number',
				'sanitize' => 'floatval',
				'sufix'    => __( 'PLN', 'essential-real-estate-tadanero' ),
			),
			'_project_funding'        => array(
				'label'    => __( 'Project amount of funding', 'essential-real-estate-tadanero' ),
				'type'     => 'number',
				'sanitize' => 'floatval',
				'sufix'    => __( 'PLN', 'essential-real-estate-tadanero' ),
			),
			'_project_currency'       => array(
				'label'    => __( 'Project currency', 'essential-real-estate-tadanero' ),
				'type'     => 'text',
				'sanitize' => 'esc_html',
				'hide'     => true,
			),
			'_project_url'            => array(
				'label'    => __( 'Project URL', 'essential-real-estate-tadanero' ),
				'type'     => 'url',
				'sanitize' => 'esc_url',
			),
		);
	...
	protected function partner_row( $data = array(), $type = '' ) {
		...
		printf(
			...
			esc_attr__( 'Remove Partner', 'essential-real-estate-tadanero' )
		);
		echo '</div>';
	}
