...
class iworks_essential_real_estate_tadanero_posttype_opinion extends iworks_essential_real_estate_tadanero_posttype_base {
			...
			'opinion-data' => array(
				...
				'fields' => array(
					array(
						'name'    => 'stars',
						'type'    => 'select',
						'label'   => esc_html__( 'The Opinion Stars', 'essential-real-estate-tadanero' ),
						'options' => array(
	...
	public function action_init_register_post_type() {
		$labels = array(
			'name'                  => _x( 'Opinions', 'Post Type General Name', 'essential-real-estate-tadanero' ),
			'singular_name'         => _x( 'Opinion', 'Post Type Singular Name', 'essential-real-estate-tadanero' ),
			'menu_name'             => __( 'Opinions', 'essential-real-estate-tadanero' ),
			'name_admin_bar'        => __( 'Opinions', 'essential-real-estate-tadanero' ),
			'archives'              => __( 'Opinions', 'essential-real-estate-tadanero' ),
			'all_items'             => __( 'Opinions', 'essential-real-estate-tadanero' ),
			'add_new_item'          => __( 'Add New Opinion', 'essential-real-estate-tadanero' ),
			'add_new'               => __( 'Add New', 'essential-real-estate-tadanero' ),
			'new_item'              => __( 'New Opinion', 'essential-real-estate-tadanero' ),
			'edit_item'             => __( 'Edit Opinion', 'essential-real-estate-tadanero' ),
			'update_item'           => __( 'Update Opinion', 'essential-real-estate-tadanero' ),
			'view_item'             => __( 'View Opinion', 'essential-real-estate-tadanero' ),
			'view_items'            => __( 'View Opinion', 'essential-real-estate-tadanero' ),
			'search_items'          => __( 'Search Opinion', 'essential-real-estate-tadanero' ),
			...
			'items_list'            => __( 'Opinion list', 'essential-real-estate-tadanero' ),
			'items_list_navigation' => __( 'Opinion list navigation', 'essential-real-estate-tadanero' ),
			'filter_items_list'     => __( 'Filter items list', 'essential-real-estate-tadanero' ),
		);
		$args   = array(
			'can_export'          => true,
			'capability_type'     => 'page',
			'description'         => __( 'Opinion', 'essential-real-estate-tadanero' ),
			'exclude_from_search' => true,
			'has_archive'         => false,
			'hierarchical'        => false,
			'label'               => __( 'Opinions', 'essential-real-estate-tadanero' ),
			'labels'              => $labels,
			...
			'rewrite'             => array(
				'slug' => _x( 'opinion', 'iWorks Post Type Opinion SLUG', 'essential-real-estate-tadanero' ),
			),
		);
		register_post_type(
