...
class iworks_essential_real_estate_tadanero_posttype_publication extends iworks_essential_real_estate_tadanero_posttype_base {
	...
	public function __construct() {
		...
		$this->meta_boxes[ $this->posttypes_names[ $this->posttype_name ] ] = array(
			'publication-data' => array(
				'title'  => __( 'Data', 'essential-real-estate-tadanero' ),
				'fields' => array(
					array(
						'name'  => 'language',
						'type'  => 'select',
						'label' => esc_html__( 'Language', 'essential-real-estate-tadanero' ),
					),
					array(
						'name'  => 'year',
						'type'  => 'year',
						'label' => esc_html__( 'Year', 'essential-real-estate-tadanero' ),
					),
					array(
						'name'  => 'authors',
						'label' => esc_html__( 'Authors', 'essential-real-estate-tadanero' ),
					),
					array(
						'name'  => 'where',
						'label' => esc_html__( 'Where', 'essential-real-estate-tadanero' ),
					),
					array(
						'name'  => 'url',
						'type'  => 'url',
						'label' => esc_html__( 'URL', 'essential-real-estate-tadanero' ),
					),
					array(
						'name'  => 'conference',
						'label' => esc_html__( 'Conference', 'essential-real-estate-tadanero' ),
					),
				),
			),
		);
	...
	public function get_random( $content, $args ) {
		...
		if ( 'pl_PL' === get_locale() ) {
			...
			$content .= sprintf( '<span class="section-title">%s</span>', esc_html__( 'Scientific publications of OPI PIB', 'essential-real-estate-tadanero' ) );
		}
	...
	public function action_init_register_post_type() {
		$labels = array(
			'name'                  => _x( 'Publications', 'Post Type General Name', 'essential-real-estate-tadanero' ),
			'singular_name'         => _x( 'Publication', 'Post Type Singular Name', 'essential-real-estate-tadanero' ),
			'menu_name'             => __( 'Publications', 'essential-real-estate-tadanero' ),
			'name_admin_bar'        => __( 'Publications', 'essential-real-estate-tadanero' ),
			'archives'              => __( 'Publications', 'essential-real-estate-tadanero' ),
			'all_items'             => __( 'Publications', 'essential-real-estate-tadanero' ),
			'add_new_item'          => __( 'Add New Publication', 'essential-real-estate-tadanero' ),
			'add_new'               => __( 'Add New', 'essential-real-estate-tadanero' ),
			'new_item'              => __( 'New Publication', 'essential-real-estate-tadanero' ),
			'edit_item'             => __( 'Edit Publication', 'essential-real-estate-tadanero' ),
			'update_item'           => __( 'Update Publication', 'essential-real-estate-tadanero' ),
			'view_item'             => __( 'View Publication', 'essential-real-estate-tadanero' ),
			'view_items'            => __( 'View Publication', 'essential-real-estate-tadanero' ),
			'search_items'          => __( 'Search Publication', 'essential-real-estate-tadanero' ),
			...
			'items_list'            => __( 'Publication list', 'essential-real-estate-tadanero' ),
			'items_list_navigation' => __( 'Publication list navigation', 'essential-real-estate-tadanero' ),
			'filter_items_list'     => __( 'Filter items list', 'essential-real-estate-tadanero' ),
		);
		$args   = array(
			'can_export'          => true,
			'capability_type'     => 'page',
			'description'         => __( 'Publication', 'essential-real-estate-tadanero' ),
			'exclude_from_search' => true,
			'has_archive'         => true,
			'hierarchical'        => false,
			'label'               => __( 'Publications', 'essential-real-estate-tadanero' ),
			'labels'              => $labels,
