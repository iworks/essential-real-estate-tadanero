...
class iworks_essential_real_estate_tadanero_posttype_faq extends iworks_essential_real_estate_tadanero_posttype_base {
	...
	public function action_init_register_post_type() {
		...
		$labels = array(
			'name'               => _x( 'FAQs', 'Post Type General Name', 'essential-real-estate-tadanero' ),
			'singular_name'      => _x( 'FAQ', 'Post Type Singular Name', 'essential-real-estate-tadanero' ),
			'menu_name'          => _x( 'FAQs', 'Menu Name', 'essential-real-estate-tadanero' ),
			'name_admin_bar'     => _x( 'FAQ', 'Admin Bar Name', 'essential-real-estate-tadanero' ),
			'parent_item_colon'  => __( 'Parent FAQ:', 'essential-real-estate-tadanero' ),
			'all_items'          => __( 'FAQs', 'essential-real-estate-tadanero' ),
			'add_new_item'       => __( 'Add New FAQ', 'essential-real-estate-tadanero' ),
			'add_new'            => __( 'Add New', 'essential-real-estate-tadanero' ),
			'new_item'           => __( 'New FAQ', 'essential-real-estate-tadanero' ),
			'edit_item'          => __( 'Edit FAQ', 'essential-real-estate-tadanero' ),
			'update_item'        => __( 'Update FAQ', 'essential-real-estate-tadanero' ),
			'view_item'          => __( 'View FAQ', 'essential-real-estate-tadanero' ),
			'search_items'       => __( 'Search FAQ', 'essential-real-estate-tadanero' ),
		...
		$args = array(
			'label'               => __( 'faq', 'essential-real-estate-tadanero' ),
			'description'         => __( 'Frequently Asked Questions', 'essential-real-estate-tadanero' ),
			...
			'rest_base'           => apply_filters(
				...
				defined( 'ICL_SITEPRESS_VERSION' ) ? 'faqs' : __( 'faqs', 'essential-real-estate-tadanero' )
			),
		);
		register_post_type(
	...
	public function action_init_register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'FAQ Groups', 'Taxonomy General Name', 'essential-real-estate-tadanero' ),
			'singular_name'              => _x( 'FAQ Group', 'Taxonomy Singular Name', 'essential-real-estate-tadanero' ),
			'menu_name'                  => __( 'Groups', 'essential-real-estate-tadanero' ),
			'all_items'                  => __( 'All FAQ Groups', 'essential-real-estate-tadanero' ),
			'parent_item'                => __( 'Parent FAQ Group', 'essential-real-estate-tadanero' ),
			'parent_item_colon'          => __( 'Parent FAQ Group:', 'essential-real-estate-tadanero' ),
			'new_item_name'              => __( 'New FAQ Group Name', 'essential-real-estate-tadanero' ),
			'add_new_item'               => __( 'Add New FAQ Group', 'essential-real-estate-tadanero' ),
			'edit_item'                  => __( 'Edit FAQ Group', 'essential-real-estate-tadanero' ),
			'update_item'                => __( 'Update FAQ Group', 'essential-real-estate-tadanero' ),
			'view_item'                  => __( 'View FAQ Group', 'essential-real-estate-tadanero' ),
			'separate_items_with_commas' => __( 'Separate FAQ Groups with commas', 'essential-real-estate-tadanero' ),
			'add_or_remove_items'        => __( 'Add or remove FAQ Groups', 'essential-real-estate-tadanero' ),
			'choose_from_most_used'      => __( 'Choose from the most used', 'essential-real-estate-tadanero' ),
			'popular_items'              => __( 'Popular FAQ Groups', 'essential-real-estate-tadanero' ),
			'search_items'               => __( 'Search FAQ Groups', 'essential-real-estate-tadanero' ),
			'not_found'                  => __( 'Not Found', 'essential-real-estate-tadanero' ),
		);
		...
		$args = array(
			...
			'rest_base'           => apply_filters(
				...
				defined( 'ICL_SITEPRESS_VERSION' ) ? 'faq_groups' : __( 'faq_groups', 'essential-real-estate-tadanero' )
			),
		);
		...
		if ( 'show' === $args['header'] ) {
			...
			if ( 'show' === $args['header-button'] ) {
				$content .= sprintf(
					...
					esc_attr__( 'Expand All', 'essential-real-estate-tadanero' ),
					esc_attr( $args['id'] ),
					esc_html__( 'Expand All', 'essential-real-estate-tadanero' )
				);
			}
		...
		while ( $the_query->have_posts() ) {
			...
			if ( 'folded' === $args['dd'] ) {
				...
				$button     = sprintf(
					...
					esc_attr(
						sprintf(
							__( 'Expand %s', 'essential-real-estate-tadanero' ),
							get_the_title()
						)
					),
					esc_html(
	...
	public function filter_wp_localize_script_iworks_theme( $data ) {
		$data['i18n']['modules']['faq'] = array(
			'button' => array(
				'expand_all'   => esc_html__( 'Expand All', 'essential-real-estate-tadanero' ),
				'collapse_all' => esc_html__( 'Collapse All', 'essential-real-estate-tadanero' ),
			),
		);
		return $data;
	}
	...
	public function get_options_list_array( $list ) {
		...
		$list  = array(
			'0' => esc_html__( '&mdash; Select &mdash;', 'essential-real-estate-tadanero' ),
		);
